	...
	<!------------------- start form for form ----------------->
		     ...
		     <div class="post-inner" style="background-color:#FDF8E8;">
                    <h1 class="name post-title endivy-title" itemprop="itemReviewed" itemscope itemtype="http://schema.org/Thing">
                        <span itemprop="name">اضف مؤسستك</span>
                    </h1>
                        
                            <div >
                               <form class="basic-grey" action="#" method="post">
                                    <div>
                                        <h2 colspan="2" class="divtitle">بيانات البرنامج</h2>
                                    ...
                                    <div>
                                        <div>اسم المؤسسة:</div>
                                        <div>
                                            <input name="name_" type="text" required="required">
                                        </div>
                                    </div>
                                    <div>
                                        <div>النشاط:</div>
                                        <div><input name="activity_" required="required" type="text" i="" class="txtbox"></div>
                                    </div>
                                    <div>
                                        <span>التفاصيل</span>
                                        <div>
                                            <textarea name="content_" required="required"></textarea>
                                        </div>
                                    </div>
                                    <div>
                                        <div> اسم المسئول :</div>
                                        <div><input name="responsible_" type="text" required="required" class="txtbox"></div>
                                    </div>
                                    <div>
                                        <div>رقم الجوال:</div>
                                        <div><input name="mobile_" type="text" class="txtbox"></div>
                                    </div>
                                    <div>
                                        <div> هاتف:</div>
                                        <div><input name="phone_" type="text" class="txtbox"></div>
                                    </div>
                                    <div>
                                        <div>الموقع الالكتروني:</div>
                                        <div><input name="website_" type="text" required="required" class="txtbox"></div>
                                    </div>
                                    <div>
                                        <div>البريد  الالكتروني:</div>
                                        <div><input name="email_" type="text" required="required" class="txtbox"></div>
                                    </div>
                                    <div>
                                        <span>الدولة:</span>
                                        <div>
                                            <input type="text" required="required" name="country_">
                                        </div>
                                    </div> 
                                    <div>
                                        <span>المنطقة:</span>
                                        <div>
                                            <input type="text" required="required" name="area_">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div> <input type="submit" name="ctl00$ContentPlaceHolder1$btnsave" value="التقدم بطلب تسجيل" class="btn"></div>
                                    </div>
                                </form>
                            </div> 
                    <!----------------- end of form         ----------->
...
<li id="menu-item-674" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-674"><a href="search-moasasa.php">البحث عن مؤسسة تدريبية</a></li>
