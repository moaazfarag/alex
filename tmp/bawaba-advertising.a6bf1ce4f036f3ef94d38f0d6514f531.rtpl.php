...
<div id="main-content" class="containersidebar-right">
	<div class="content">
		...
		<article class="post-567 page type-page status-publish has-post-thumbnail hentry post-listing post">
					<div class="single-post-thumb">
			<img width="660" height="330" src="./template/wp-content/uploads/2015/01/433-e1422105277831-660x330.jpg" class="attachment-slider" alt="البوابة الاعلامية" title="البوابة الاعلامية">		</div>
		
		
			<div class="post-inner">
				<h1 class="name post-title entry-title" itemprop="itemReviewed" itemscope="" itemtype="http://schema.org/Thing"><span itemprop="name">البوابة الاعلامية</span></h1>
				<p class="post-meta"></p>
				<div class="clear"></div>
				<div class="entry">
					
					<p>لعبت الصحافة المتخصصة في مجال الاتصالات وتكنولوجيا المعلومات، خلال السنوات السابقة دوراً محورياً ومؤثراً في تنمية القطاع &nbsp;وكل المتغيرات والتحركات التي يشهدها هذا القطاع الواعد، ومن ناحية أخري فإن التطورات الراهنة في مختلف المجالات التكنولوجية كانت هي الأخري أحد العناصر المؤثرة في تقديم تغطيات صحفية متميزة وسريعة للأحداث المختلفة، وساعدت المحررين علي القيام بمهامهم بشكل تنافسي واحترافي للأحداث في أسرع وقت ممكن، وهو ما بحثه المؤتمر الأول لشعبة محرري الاتصالات وتكنولوجيا المعلومات،</p>
...
<aside id="sidebar">
<div id="nav_menu-2" class="widget widget_nav_menu"><div class="widget-top"><h4>البوابة الاعلامية</h4><div class="stripe-line"></div></div>
