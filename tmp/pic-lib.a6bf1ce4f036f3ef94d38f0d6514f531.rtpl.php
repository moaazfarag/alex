	...
	<div class="content">
		...
		<article class="post-572 page type-page status-publish hentry post-listing post">
			...
			<div class="post-inner">
				<h1 class="name post-title entry-title" itemprop="itemReviewed" itemscope itemtype="http://schema.org/Thing"><span itemprop="name">مكتبة الصور</span></h1>
				<p class="post-meta"></p>
				<div class="clear"></div>
				<div class="entry">
		...
		<div id="photoswipe_gallery_572_1" class="photoswipe_gallery gallery-columns-3 gallery-size-thumbnail" itemscope itemtype="http://schema.org/ImageGallery" >
				...
				<figure class="msnry_item" itemscope itemtype="http://schema.org/ImageObject">
					<a href="template/wp-content/uploads/2012/07/5709944739_578bc434a7_b.jpg" itemprop="contentUrl" data-size="1024x683">
				        <img src=template/wp-content/uploads/2012/07/5709944739_578bc434a7_b.jpg itemprop="thumbnail" alt=""  />
				    </a>
				    <figcaption class="photoswipe-gallery-caption" ></figcaption>
			    </figure>
